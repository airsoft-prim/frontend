 ...
 *
 * На /users/me/ номера в адресе нет — там стоит «me», и это тот же самый
 * профиль, только свой: собственный номер придёт вместе с авторизацией,
 * а пока на его месте заглушка. Проверки существования игрока тоже нет —
 * принимаем любой 32-значный hex (валидация появится вместе с API).
 * Поэтому «me» в номер не превращается: его отсекает сама маска hex.
 */
