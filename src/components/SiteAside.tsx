...
function ProfileBlock() {
  return (
    <Group wrap="nowrap" align="flex-start" gap="md" mt="lg">
       ...
       * нейтральная: действие второстепенное. «Профиль» ведёт на /me/ — это
       * шорткат для /users/{hex}; «Настройки» пока заглушка — такой страницы
       * нет, поэтому пункт ничего не открывает (как действие паллетки без
       * href). Значок у каждого пункта свой: он подсказывает, куда пункт
       * ведёт, ещё до чтения подписи */}
