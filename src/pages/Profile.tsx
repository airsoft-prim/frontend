 ...
 *
 * Отвечает и на `/users/me/`, и на `/users/{hex}`: это один и тот же
 * документ, а игрок приходит из адреса (см. ProfilePassport) — «me»
 * означает свой профиль, hex — чужой. Общий блок пользователя слева
 * (`aside`) здесь не нужен: страница и есть блок пользователя, только
 * развёрнутый на всю ширину.
 *
